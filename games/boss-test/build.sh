#!/bin/bash
# ============================================
# Boss Test - Build Script
# ============================================
# Standalone giant boss figure-8 demo
#
# Usage: ./build.sh [run]
...
ASM="$BUILD_DIR/boss-test.asm"
ROM="$BUILD_DIR/boss-test.rom"
LST="$BUILD_DIR/boss-test.lst"

echo "=== Boss Test Build ==="
