#!/bin/bash
# ============================================
# Test Pattern - Build Script
# ============================================
# Color test pattern for Intellivision
#
# Usage: ./build.sh [run]
...
ASM="$BUILD_DIR/testpattern.asm"
ROM="$BUILD_DIR/testpattern.rom"
LST="$BUILD_DIR/testpattern.lst"

echo "=== Test Pattern Build ==="
