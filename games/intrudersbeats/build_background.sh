#!/bin/bash
# ============================================
# Intruder Background - Build Script
# ============================================
#
# Usage: ./build_background.sh [run]
...
# File names
SRC="$GAME_DIR/src/intruderbackground.bas"
ASM="$BUILD_DIR/intruderbackground.asm"
ROM="$BUILD_DIR/intruderbackground.rom"
LST="$BUILD_DIR/intruderbackground.lst"

echo "=== Intruder Background Build ==="
