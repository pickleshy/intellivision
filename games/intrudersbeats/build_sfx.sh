#!/bin/bash
# ============================================
# Intruder SFX - Build Script
# ============================================
#
# Usage: ./build_sfx.sh [run]
...
# File names
SRC="$GAME_DIR/src/intrudersfx.bas"
ASM="$BUILD_DIR/intrudersfx.asm"
ROM="$BUILD_DIR/intrudersfx.rom"
LST="$BUILD_DIR/intrudersfx.lst"

echo "=== Intruder SFX Build ==="
