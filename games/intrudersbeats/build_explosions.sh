#!/bin/bash
# ============================================
# Intruder Explosions - Build Script
# ============================================
#
# Usage: ./build_explosions.sh [run]
...
# File names
SRC="$GAME_DIR/src/intruderexplosions.bas"
ASM="$BUILD_DIR/intruderexplosions.asm"
ROM="$BUILD_DIR/intruderexplosions.rom"
LST="$BUILD_DIR/intruderexplosions.lst"

echo "=== Intruder Explosions Build ==="
