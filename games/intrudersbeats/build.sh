...
# File names
SRC="$GAME_DIR/src/intrudersbeats.bas"
ASM="$BUILD_DIR/intrudersbeats.asm"
ROM="$BUILD_DIR/intrudersbeats.rom"
LST="$BUILD_DIR/intrudersbeats.lst"

echo "=== Intruders Beats Build ==="
