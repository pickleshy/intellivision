#!/bin/bash
# ============================================
# Starfield Demo - Build Script
# ============================================
# Starfield effect showcase for Intellivision
#
# Usage: ./build.sh [run]
...
ASM="$BUILD_DIR/starfield.asm"
ROM="$BUILD_DIR/starfield.rom"
LST="$BUILD_DIR/starfield.lst"

echo "=== Starfield Demo Build ==="
